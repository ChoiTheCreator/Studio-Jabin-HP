  ...
  return (
    <main className="min-h-dvh bg-paper" aria-busy="true">
      ...
      <div className="motion-safe:animate-pulse" aria-hidden="true">
        ...
        >
          <div className="h-6 w-21 bg-ink/10" />
          <div className="h-4 w-14 bg-ink/10" />
        </div>

        <div className={`${pageShell} py-18 sm:py-24 lg:py-32`}>
          <div className="grid gap-12 lg:grid-cols-[minmax(220px,0.65fr)_minmax(0,1.35fr)] lg:gap-20">
            <div>
              <div className="h-4 w-14 bg-blue/20" />
              <div className="mt-6 h-11 w-40 bg-ink/10 sm:h-16 sm:w-56" />
              <div className="mt-3 h-11 w-32 bg-ink/10 sm:h-16 sm:w-44" />
            ...
            <div className="grid gap-14">
              {Array.from({ length: 6 }).map((_, index) => (
                <div className="border-t border-ink/20 pt-5" key={index}>
                  <div className="h-6 w-40 bg-ink/10 sm:h-8 sm:w-52" />
