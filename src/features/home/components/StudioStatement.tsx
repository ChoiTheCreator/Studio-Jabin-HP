    ...
    <section className="bg-white text-navy-ink" id="approach" aria-labelledby="statement-title">
      <div className={`${contentShell} py-22 sm:py-28 lg:py-32`}>
        ...
        <Reveal className="mt-12 sm:mt-16" delay={60}>
          <h2
            className="m-0 max-w-270 text-[40px] leading-[1.08] font-bold break-keep sm:text-[56px] lg:text-[72px]"
            id="statement-title"
          >
            당신의 웹사이트도,
            <br />
        ...
        <Reveal className="mt-10 max-w-175 sm:mt-12 lg:ml-auto lg:w-[58%]" delay={120}>
          <p className="m-0 text-[22px] leading-[1.45] font-bold break-keep text-navy-deep sm:text-[28px]">
            빨리 만드는 것보다, 제대로 다르게 만드는 것.
          </p>
          <p className="mt-7 mb-0 max-w-170 text-[16px] leading-[1.7] break-keep text-navy-muted sm:text-[17px]">
